...
pushd $ECLIPSEHOME/Contents/Eclipse/plugins

download_if_not_exists https://github.com/fsc4j/fsc4j/releases/download/0_0_6 org.eclipse.jdt.core_3.21.0.fsc4j_0_0_6.jar
download_if_not_exists https://github.com/fsc4j/fsc4j/releases/download/0_0_2 org.eclipse.jdt.debug_3.14.0.fsc4j_0_0_2.jar

cd ../configuration/org.eclipse.equinox.simpleconfigurator

JDT_CORE_LINE=org.eclipse.jdt.core,3.21.0.fsc4j_0_0_6,plugins/org.eclipse.jdt.core_3.21.0.fsc4j_0_0_6.jar,4,false
JDT_DEBUG_LINE=org.eclipse.jdt.debug,3.14.0.fsc4j_0_0_2,plugins/org.eclipse.jdt.debug_3.14.0.fsc4j_0_0_2.jar,4,false
...
if xattr -p com.apple.quarantine Eclipse.app > /dev/null 2>&1; then
  ...
  echo ""
  echo "Skipped removal of com.apple.quarantine attribute; it has already been removed."
fi

popd
echo ""
echo "FSC4J 0.0.6 installed successfully"
echo ""
